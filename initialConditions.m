...
% Microgrid Settings
panelArea = 610;   % Area of PV Array [m^2]
panelEff = 0.20;     % Efficiency of Array
loadBase = 5e3;   % Base Load of Microgrid [W]

BattCap = 572;     % Energy Storage Rated Capacity [kWh]
batteryMinMax.Pmin = -148e3;    % Max Discharge Rate [W]
batteryMinMax.Pmax = 148e3;     % Max Charge Rate [W]
